...
CONTRACT_REGEX='^(robot_description_contract|motion_profile_contract|practice_world_probe_contract|launch_shutdown_contract|sensor_contract_probe_contract|sensor_contract_ci|base_feedback|ground_truth_contract|ground_truth_alignment_math|ground_truth_display|motion_profile_(divergence_ideal|yaw_ideal)|wheel_odometry_resilience)$'
