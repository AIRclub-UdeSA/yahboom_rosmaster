...
CONTRACT_REGEX='^(flake8|pep257|xmllint|lint_cmake|robot_description_contract|motion_profile_contract|practice_world_probe_contract|launch_shutdown_contract|sensor_contract_probe_contract|sensor_contract_ci|base_feedback|ground_truth_contract|ground_truth_alignment_math|ground_truth_display|ground_truth_odom_mode|ground_truth_map_mode|motion_profile_(divergence_ideal|yaw_ideal)|wheel_odometry_resilience)$'
