#!/usr/bin/env python3
"""Launch-test the ground_truth_frame:=map wait-for-map mode without Gazebo."""
...
class TestGroundTruthMapMode(unittest.TestCase):
    """Require the wait-for-map probe to pass."""
