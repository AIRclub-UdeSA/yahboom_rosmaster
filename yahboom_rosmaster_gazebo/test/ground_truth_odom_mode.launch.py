#!/usr/bin/env python3
"""Launch-test the ground_truth_frame:=odom opt-out without Gazebo."""
...
class TestGroundTruthOdomMode(unittest.TestCase):
    """Require the opt-out probe to pass."""
