...
def generate_launch_description():
    ...
    # The Fortress backend routes /cmd_vel through this node to make an
    # uncalibrated mecanum base drift the way the physical one does. planar_move
    # has no command timeout either, so the watchdog's zero-on-silence also stops
    # the robot when a teleop terminal is closed mid-command.
